        ...
        <MDBCol col='12'>
          ...
          <MDBCard className='text-dark my-5 mx-auto' style={{borderRadius: '1rem', maxWidth: '400px' ,backgroundColor: "#ffffff"}}>
            <MDBCardBody className='p-5 d-flex flex-column align-items-center mx-auto w-100'>
              ...
              <MDBInput wrapperClass='mb-4 mx-5 w-100'  labelClass='text-black' label='Email address' id='formControlLg'  type='email' className='form-control' size="lg"/>
              <MDBInput wrapperClass=' mb-4 mx-5 w-100' labelClass='text-black' label='Password' id='formControlLg' type='password' size="lg"/>

              <p className="small mb-3 pb-lg-2"><a class="text-blue-50" href="#!">Forgot password?</a></p>
              ...
              <div>
                <p className="mb-0">Don't have an account? <a href="front-end/src/Register.js" class="text-50 fw-bold"  style={{ color: '#eb6f3e' }}>Sign Up</a></p>
